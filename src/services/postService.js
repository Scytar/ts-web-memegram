...
var newPost = function (dataPost) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, postRep.insert({ media: dataPost.media, authorId: dataPost.authorId, author: dataPost.author })];
            case 1:
                response = _a.sent();
                //---------------------------------------------------------------------------verify
                if (!response.error) {
