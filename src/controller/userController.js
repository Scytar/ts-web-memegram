...
exports.logout = exports.newUser = exports.login = void 0;
var UserService_1 = require("../services/UserService");
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userData, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, UserService_1.selectUser)(userData)];
                case 2:
                    data = _a.sent();
