...
exports.newLike = void 0;
var likeService_1 = require("../services/likeService");
var secret = 'xfeyi356##$qsWRE';
function newLike(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var likeData, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    likeData = req.body;
                    if (!(Object.keys(likeData).length === 0)) return [3 /*break*/, 1];
                    res.status(400).send("Invalid request");
                    return [2 /*return*/];
                case 1: return [4 /*yield*/, (0, likeService_1.insertLike)(likeData)];
                case 2:
                    data = _a.sent();
