...
exports.listComment = exports.newComment = void 0;
var commentService_1 = require("../services/commentService");
var secret = 'xfeyi356##$qsWRE';
function newComment(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var commentData, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    commentData = req.body;
                    if (!(Object.keys(commentData).length === 0)) return [3 /*break*/, 1];
                    res.status(400).send("Invalid request");
                    return [2 /*return*/];
                case 1: return [4 /*yield*/, (0, commentService_1.insertComment)(commentData)];
                case 2:
                    data = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, commentService_1.getComment)(postId)];
                case 1:
                    data = _a.sent();
                    if (data === null || data === void 0 ? void 0 : data.err) {
                        throw new Error(data.err);
